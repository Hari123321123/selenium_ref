...
FileInputStream fis = new FileInputStream("C:\\Users\\admin\\Desktop\\reqparameter.xlsx");
...
if(cellvalue.getStringCellValue().equalsIgnoreCase("dates"))
{
tc_column=j;
}
j++;
